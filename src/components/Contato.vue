<template>
    <footer class="bg-kldarkblue pt-10 mt-10" id="Contato">

        <div class="grid grid-cols-1 lg:grid-cols-4 justify-items-center gap-4 ">
        ...
        <div class="flex flex-col pt-10">
            <h3 class="text-center text-white">Todos os Direitos Reservados © </h3>
        </div>
