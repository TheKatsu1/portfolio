<template>
    <div class="grid grid-cols-1 lg:grid-cols-2 mt-20">
        <div class="text-center">
            <h1
                class="text-8xl mb-5 font-extrabold text-transparent bg-clip-text bg-gradient-to-r from-kldarkblue to-klblue text-center">
                Katsu</h1>
            <h2
                class="text-4xl mb-5 font-extrabold text-transparent bg-clip-text bg-gradient-to-r from-kldarkblue to-klblue text-center">
                Front-End Developer</h2>
            <p class="mx-16 mb-5 text-black text-justify">Meu nome é João Victor Silveira Domingues mas todo mundo me chama
                pelo meu apelido (Katsu), estudo assuntos relacionados a tecnologia desde 2018 quando comecei meu curso
