    ...
    <div class="grid grid-cols-1 lg:grid-cols-3 gap-2 pl-6 pt-10">
        <div class="max-w-sm bg-white border-2 border-kldarkblue rounded-lg shadow dark:bg-gray-800 dark:border-gray-700">
            ...
            <div class="p-5">
                ...
                <h5
                    class="mb-2 text-2xl font-bold tracking-tight text-transparent bg-clip-text bg-gradient-to-r from-kldarkblue to-klblue">
                    HitCookie</h5>
                ...
                <p class="mb-3 font-normal text-gray-700 dark:text-gray-400">Site institucional realizado para o restaurante
